...
document.addEventListener('puzzleInputLoaded', () => {
  ...
  function battle(currentState) {
    // Part 2
    currentState.playerHP-- // Part 2: player loses one hit point at the start of each player turn
    if (currentState.playerHP === 0) return // Part 2: New way of player defeat
