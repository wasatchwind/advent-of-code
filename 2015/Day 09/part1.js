...
document.addEventListener('puzzleInputLoaded', () => {
  ...
  // Shortest distance is the smallest value of all distance array elements
  document.getElementById('answer').innerText = Math.min(...distances)
  console.log('The shortest route distance is', Math.min(...distances))
})
